...
const courses = {
  1: {
    ...
    notes:
      "React is a JavaScript library for building user interfaces. It uses components to structure your app.",
    quiz: [
  ...
  2: {
    ...
    notes:
      "Advanced JS topics include closures, async/await, and higher-order functions.",
    quiz: [
        ...
        {activeTab === "quiz" && (
          <div className="quiz-section">
            {!completed ? (
              <>
                <p>
                  <strong>Q:</strong> {course.quiz[quizIndex].q}
                </p>
                <p>
                  <strong>A:</strong> {course.quiz[quizIndex].a}
                </p>
